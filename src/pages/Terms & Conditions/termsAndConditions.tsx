...
<br />
<br />
THESE TERMS ALSO INCLUDE A LIMITATION OF LIABILITY (SECTION 3) FOR ALL CLAIMS FOR DAMAGES AGAINST SIANNOVA LLC THAT MAY ARISE OUT OF YOUR USE OF THE PLATFORM.
<br />
<br />
The Platform is owned and operated by Siannova LLC, a Massachusetts (USA) limited liability company. Any references herein to Siannova LLC, https://timezoneplanner.com/, “Company,” “we,” “our,” or “us” shall be deemed to refer to the Platform and/or Siannova LLC, as applicable under the circumstances.
<br />
<br />
Note to Social Media Users. When purchasing Products and Services from the Website, our LinkedIn profile, or other social media page, and when posting information to or otherwise communicating via that page or your own social media page, your activities online are subject to the Terms and Conditions, User’s Agreement, or other terms and conditions imposed by that social media website, which may contain terms and conditions different from these Terms and Conditions. Please see the following pages for further details:
<br />
Facebook’s Statement of Rights and Responsibilities<br />
LinkedIn’s User’s Agreement<br />
Twitter’s Terms and Conditions<br />
Google’s Terms and Conditions<br /> <br />
All references in these Terms and Conditions to “Siannova LLC”, “https://timezoneplanner.com/,” and/or “the Website(s)” shall be deemed to include both the Website(s) and any and all social media pages maintained from time to time by Siannova LLC or its affiliates. <br />
<br /><br />
<h2>1. OUR PRODUCTS; TERMS OF SALE SUBSCRIPTION</h2>
By agreeing to these Terms, Company licenses its Platform to you on a subscription basis. Any fees which Company may charge you for the use of the Platform may be as set out on the Platform or in an order form at the time of purchase for the subscription are due immediately (unless an order form states otherwise) and are subject to the refund policy of the Company stated in this section.
<br /><br />
By default all subscriptions unless stated otherwise in writing have auto renew as a feature. If you have a subscription with an auto renewal as a feature, you authorize Company to maintain your account information and charge that account automatically upon the renewal of the subscription you chose with no further action required by you. In the even that Company is unable to charge your account as authorized by you when you enrolled in an auto-renewing subscription, Company, may, in its sole discretion: (i) bill you for your previously selected subscription type and suspend your access to the Platform until payment is received, and/or (ii) seek to update your account information through third party sources (i.e., your bank or a payment processor) to continue charging your account as authorized by you.
<br /><br />
In addition to the price due for your subscription, if there are delinquent amounts or chargebacks associated with your payment, you may be charged fees that are incidental to our collection of these delinquent amounts and chargebacks. Such fees or charges may include collection fees, convenience fees or other third-party charges.
<br /><br />
...
<br /><br />
<h3>Payment.</h3>
All amounts due for purchases of Products are payable in full at the time of purchase.
<br /><br />
<h3>Your Account.</h3>
...
All prices for Products (and the associated costs of shipping and tax) are shown in U.S. dollars. Depending upon your credit card’s currency and the country in which your card was issued, your credit card provider may impose foreign exchange fees, conversion fees and other fees which are in accordance with your arrangements with that credit card provider. If you have any questions about these fees or the exchange rate applied to your payment, please contact your bank. Company is not responsible for such fees and will not reimburse you for any such fees incurred. All items are subject to availability and we reserve the right to impose quantity limits on any order, to reject all or part of an order, and to discontinue Products without notice, even if you have already placed your order. Company, at its sole discretion, may make promotional offers with different features and different rate to any of Company’s customers. All prices are subject to change without notice as the Company deems necessary for Company’s business at any time. You agree that taxes may be adjusted from the amount shown on the payment screens. Several factors may cause this, such as variances between processor programs and changes in tax rates. Company, at its sole discretion, may make promotional offers with different features and different rate to any of Company’s customers.
<br /><br />
<h3>Currency Conversion.</h3>
Company may, in its sole discretion, round up or round down amounts that are payable from you to the nearest whole functional base unit in which the currency is denominated (i.e. to the nearest dollar, Euro, or other supported currency); for example and not by way of limitation, Company may round up an amount of $100.50 to $101.00 and round down on an amount of $100.49 to $100.00. For currencies that are denominated in large numbers, Company may determine the functional base unit in which those currencies are denominated to be 10, 100, or 1000 of the currency; for example and not by way of limitation, Company may round up an amount of 1135 to 1140 and 1134 down to 1130 if the currency is denominated by base 10.
<br /> <br />
<h3>Payment Terms.</h3>
Company currently accepts Visa, MasterCard, and American Express credit and debit cards (collectively, “Payment Method”). By submitting your order, you represent and warrant that you are authorized to use the designated Payment Method and authorize us to charge your order (including taxes, shipping, and handling) to that Payment Method. If the Payment Method cannot be verified, is invalid, or is otherwise not acceptable, your order may be suspended or cancelled automatically.
<br /> <br />

<h3>Chargeback Policy.</h3>
All references to a “chargeback” refer to a reversal of your Payment Method charge placed on this Platform. In the event you pay for Products using your Payment Method and subsequently “charge back” your purchase through your merchant account provider, Company reserves the right to terminate these Terms and Conditions and all pending orders and transactions immediately, in addition to any and all available remedies at law or in equity. Unnecessary chargebacks are theft and can be prosecuted. If you feel that your Payment Method was used fraudulently, please contact us for immediate resolution.
<br /><br />
YOU AGREE THAT YOU WILL NOT CHARGEBACK ANY AMOUNTS CHARGED TO YOUR PAYMENT METHOD ON THIS PLATFORM. IF YOU CHARGEBACK YOUR PAYMENT METHOD CHARGE FOR A PAYMENT INITIATED BY YOU, YOU AGREE THAT COMPANY MAY RECOVER THE AMOUNT OF THE CHARGEBACK, IN ADDITION TO ANY AMOUNT CHARGED US BY THE COMPANY ASSOCIATED WITH YOUR PAYMENT METHOD FOR SUCH CHARGEBACK, BY ANY MEANS DEEMED NECESSARY, INCLUDING BUT NOT LIMITED TO RECHARGING YOUR PAYMENT METHOD OR HAVING THE AMOUNT RECOVERED BY A COLLECTION AGENCY.
<br /><br />
<h3>Refund Policy.</h3>
Company will not, under any circumstances, issue any cash refunds for early contract cancellation. If you have a question about charges made to your account, please contact us immediately at EMAIL. If we determine that the charges were made in error, we will credit your account or credit card account for the appropriate amount. Any past due fees and costs will be sent to collections. If our collection efforts fail, unpaid debts will be reported to all available credit reporting agencies.

<h3>Reconnection Fee.</h3>
In the event you are suspended from your account for any reason caused by you and you wish to renew your access to the Platform, Company reserves the right to impose a reconnection fee not to exceed $100.
<br /><br />
<h2>2. INTELLECTUAL PROPERTY</h2>
In General.
You acknowledge that Company owns all right, title, and interest in and to the Platform, including without limitation all intellectual property rights, and such rights are protected by U.S. and international intellectual property laws. You agree that you will not copy, reproduce, alter, modify, or create derivative works from any portion of the Platform. Such rights derive from any of Company’s copyrights, trademarks, patents, trade dress, and other such intellectual property rights that Company may have with regard to the Platform.
<br /><br />

Additionally, you acknowledge that these Terms do not convey or grant you any rights to use or reference in any manner Company’s name(s), logos, trademarks, product names, and/or service names.
<br /><br />
...
Force Majeure.
In addition to any excuse provided by applicable law, Company and its Providers shall be excused from liability for non-delivery or delay in delivery of Products or Services available through this Platform arising from any event beyond our reasonable control, whether or not foreseeable by either party, including but not limited to: labor disturbance, war, fire, accident, adverse weather, inability to secure transportation, governmental act or regulation, and other causes or events beyond our reasonable control, whether or not similar to those which are enumerated above.
<br /><br />

Connectivity, Mobile.
Normal carrier charges and taxes may apply to any part of the Platform you access from the Company Website or from any mobile applications that may be part of the Platform. Company is not responsible for any surcharges you incur from your cell phone or internet service provider as a result of the use of the Website or any mobile applications associated with the Platform. With respect to mobile versions or applications, your carriers’ normal rates and fees, including text messaging and data fees may apply to your use of the Platform. In the event you charge or deactivate your mobile telephone number, you are required to update your account information within 48 hours to ensure that your messages are not sent to the person who acquires your old number. Any damages Company may incur due to your failure to inform Company of such a change in phone number shall be covered by Company’s Indemnification Policy pursuant to this Section 3 of these Terms.
<br /><br />

Links to Third Party Sites.
This Platform may contain links to third party sites. These links are provided for convenience purposes and are not under the control of Company. If you choose to link to such third party websites, Company makes no warranties, either expressed or implied, concerning the content of such sites, including the operations, programming, and conduct of transactions over such sites. Company does not warrant that such sites or content are free from any claims of copyright or other infringement or that such sites or content are devoid of viruses. Company disclaims all liability of any kind whatsoever arising out of your use of, or inability to use, such third party websites, the use of your information by such third parties, and the security of information you provide to such third parties.
<br /><br />

Downloading From App Stores.
Some or all of Company’s products including the Platform may be available as a download from third party mobile application marketplaces (“App Stores”). Should you download from an App Store, you acknowledge and agree that:
<br /><br />

The App Store has no obligation to aid in your use of the Platform and any support services you may need;
The App Store is not responsible for addressing any claims you may have against any user or Company;
By accepting these Terms, you are agreeing to any App Store Terms and Conditions and End User License Agreement, and will comply with all applicable terms in your downloading and use of the Platform.
Payment Processor.
Company uses a payment gateway to process payments made through the Platform (e.g. you purchasing a subscription from Company). For such payment processing, Company uses https://www.lemonsqueezy.com/. You agree to abide by the terms and conditions of Stripe as elucidated here: https://www.lemonsqueezy.com/terms.
<br /><br />
...
Furthermore, by transmitting any message, communication, information or data including photos, contact information, or text, and any other User Content, you grant Company and its affiliates a non-exclusive, transferable, sub-licensable, royalty-free, worldwide license to use any intellectual property content to collect, use, store, handle, reproduce, display, perform, and transmit such User Content for the purpose of providing the Platform and the Products Company provides. You represent and warrant, and can demonstrate to Company’s full satisfaction upon request that you (a) own or otherwise control all rights to all User Content, or that the User Content is in the public domain, (b) have the permission to use the name and likeness of each identifiable individual person in such User Content and to use such individual’s identifying or personal information as contemplated by these Terms, and (c) are authorized to grant all of the aforementioned rights to the User Content to Company.

You agree that Company, in its sole discretion, has the authority to remove any User Content if in Company’s sole discretion, the User Content is inaccurate, vulgar, defamatory, or otherwise inappropriate. If you believe that User Content you find on the Platform is inappropriate or otherwise inaccurate, please let Company know at siannovallc@gmail.com.

DMCA Policy.
Company respects the intellectual property rights of others and expects its users to do the same. Pursuant to this goal and the Digital Millennium Copyright Act (DMCA). 17 U.S.C. Section 512(c), a copyright owner may submit a takedown request with the listed DMCA Agent below. Infringers of Company’s copyright policies listed herein and in Company’s Terms may lead to the termination of said infringer’s account.
...
Send all notifications pursuant to this section to siannovallc@gmail.com
...
In accordance with the terms of Company’s Privacy Policy, Company respects the privacy of its users. To view our Privacy Policy, which is incorporated into these Terms by reference, click here: https://www.timezoneplanner.com/privacy.
...
12. APPLICABLE LAW
These Terms and Conditions and this Website are created and controlled by Company, a limited liability company organized in the Commonwealth of Massachusetts, U.S.A. As such, the laws of the Commonwealth of Massachusetts, U.S.A., will govern these Terms and Conditions, without giving effect to any principles of conflicts of laws. Subject to Section 14, you hereby irrevocably and unconditionally consent to submit to the exclusive jurisdiction of the courts of the Commonwealth of Massachusetts, U.S.A., for any litigation arising out of or relating to use of or purchase made through Company (and agree not to commence any litigation relating thereto except in such courts), waive any objection to the laying of venue of any such litigation in the courts of Middlesex County, in the Commonwealth of Massachusetts, U.S.A., and agree not to plead or claim in any court of Middlesex County in the Commonwealth of Massachusetts, U.S.A., that such litigation brought therein has been brought in an inconvenient forum. The submission in this Section 12 herein shall not affect the right of Company to take proceedings in any other jurisdiction nor shall the taking of proceedings in any jurisdiction preclude Company from taking proceedings in any other jurisdiction.
...
14.1 Litigation: Any dispute, controversy, or claim arising out of or relating to these Terms, including the validity, interpretation, breach, or termination thereof, shall be resolved through litigation in a court of competent jurisdiction, and not through arbitration.
14.2 Governing Law: These Terms shall be governed by and construed in accordance with the laws of the Commonwealth of Massachusetts, without regard to its conflict of law principles.
14.3 Jurisdiction: You agree that any legal action or proceeding between you and Siannova LLC shall be brought exclusively in the state or federal courts located in Middlesex County, Massachusetts. You consent to the personal jurisdiction and venue in such courts.
14.4 Class Action Waiver: You agree to waive any right to participate in a class action lawsuit or class-wide arbitration against Siannova LLC.
14.5 Injunctive Relief: Notwithstanding the foregoing, Siannova LLC may seek injunctive or other equitable relief to protect its intellectual property rights in any court of competent jurisdiction.
14.6 Legal Fees: In the event of any legal action or proceeding between you and Siannova LLC, the prevailing party shall be entitled to recover its reasonable attorneys' fees and other costs incurred in that action or proceeding, in addition to any other relief to which it may be entitled.
...
<br />
17. CONTACTING US
If you have any questions about these Terms and Conditions or your dealings with this Website, please feel free to email us at siannovallc@gmail.com.
      ...
      {/* <iframe style={{width: "100%", height: "90vh"}} src="https://v2-embednotion.com/Our-Terms-Conditions-df4ae95233094afd9bb49596cc1f3a52" frameborder="0"></iframe> */}
